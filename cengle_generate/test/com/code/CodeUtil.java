...
/*	public static void main(String[] args) {
	...
	*/
	...
	private static void config() {
		...
		//文件解析方法配置实体类，对应于数据库表emv_file_process_method
		//文件解析方法配置实体类，对应于数据库表emv_file_process_method
		//文件迁移记录实体类，对应于数据库表emv_file_transfer_record
		 String tableName="emv_file_cos"; //
		 String codeName ="COS管理";//中文注释  当然你用英文也是可以的 
		 String entityPackage ="";//实体包
		 String keyType = FtlDef.KEY_TYPE_02;//主键生成方式 01:UUID  02:自增
		 //CodeGenerateFactory.codeGenerate(tableName, codeName,entityPackage,keyType);
		 String entityName ="";
		CodeGenerateFactory.codeGenerate(tableName,entityName, codeName,entityPackage,keyType);//
	}
